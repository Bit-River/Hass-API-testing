...
def cylon():
    ...
    for cy in range (1):
        ...
        for i in range(0,16,1):
            ...
            mote.set_pixel(3,i,250,0,0)
            mote.set_pixel(4,i,250,0,0)
            mote.show()
            time.sleep(0.1)
            mote.clear()
    ...
    for i in range(0,16,1):
            ...
            mote.set_pixel(3,i,255,153,0)
            mote.set_pixel(4,i,255,153,0)
            mote.show()
            time.sleep(0.1)
...
@app.route('/mote/api/v1.0/cylon3', methods=['GET'])
def cylon3():
...
@app.route('/mote/api/v1.0/cylon4', methods=['GET'])
def cylon4():
...
@app.route('/mote/api/v1.0/cylon5', methods=['GET'])
def cylon5():
...
@app.route('/mote/api/v1.0/rainbow4', methods=['GET'])
def rainbow4():
...
def tiedye():
    ...
    for pixel in range(16):
            ...
            mote.set_pixel(3, pixel, 235, 153, 0)
            mote.set_pixel(4, pixel, 235, 153, 0)
